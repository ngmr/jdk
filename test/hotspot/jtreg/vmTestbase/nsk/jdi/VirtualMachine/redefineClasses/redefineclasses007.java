 ...
 *     <code>redefineclasses007.java</code>             - debugger              <br>
 *     <code>redefineclasses007a.java</code>            - initial debuggee      <br>
 *     <code>newclassXX/redefineclasses007a.java</code> - redefining debuggees  <br>
 *
 * Initial debugee-class has four dummy methods with different kind of accessibility:
 * <code>public</code>, <code>protected<code>, <code>private</code> and
 * default access (package private).
 * This test performs the following cases:                   <br>
 *    1. adding <static> modifiers to public method          <br>
 *    2. adding <static> modifiers to 4 methods              <br>
 *    3. adding <final> modifiers to public method           <br>
...
public class redefineclasses007 {
    ...
    private final static String debuggerName = prefix + "redefineclasses007";
    private final static String debugeeName = debuggerName + "a";

    private final static String[][] subDirs = {
            {"newclass01","adding <static> modifiers to public method"},
            {"newclass02","adding <static> modifiers to 4 methods"},
    ...
    public static int run(String argv[], PrintStream out) {
        ...
        redefineclasses007 thisTest = new redefineclasses007();
    ...
    private void execTest() throws TestBug {
        ...
        BreakpointRequest brkp = debugee.setBreakpoint(testedClass,
                                                    redefineclasses007a.brkpMethodName,
                                                    redefineclasses007a.brkpLineNumber);
        debugee.resume();
        debugee.sendSignal("continue");
