 ...
 *     <code>redefineclasses013.java</code>             - debugger              <br>
 *     <code>redefineclasses013a.java</code>            - initial debuggee      <br>
 *     <code>newclassXX/redefineclasses013a.java</code> - redefining debuggees  <br>
 *
 * This test performs the following cases:                                      <br>
 *    1. newclass01 - adding new method declared as                             <br>
 *                    <code>abstract public void newMethod()</code>             <br>
 *    2. newclass02 - adding new method declared as                             <br>
 *                    <code>public void newMethod()</code>                      <br>
 *    3. newclass03 - adding new method declared as                             <br>
 *                    <code>void newMethod()</code>                             <br>
...
public class redefineclasses013 {
    ...
    private final static String debuggerName = prefix + "redefineclasses013";
    private final static String debugeeName = debuggerName + "a";
    private final static String testedClassName = debuggerName + "b";

    private final static String[][] subDirs = {
            {"newclass01","adding \"abstract public void newMethod()\""},
            {"newclass02","adding \"public void newMethod()\""},
            {"newclass03","adding \"void newMethod()\""}
    };

    private final static String newClassFile = File.separator
                    + prefix.replace('.',File.separatorChar)
                    + "redefineclasses013b.class";
    ...
    public static int run(String argv[], PrintStream out) {
        ...
        redefineclasses013 thisTest = new redefineclasses013();
