 ...
 *    to add a class modifiers will throw <code>UnsupportedOperationException</code>
 *    exception."
 *
 * The test consists of the following files:                                    <br>
 *     <code>redefineclasses020.java</code>             - debugger              <br>
 *     <code>redefineclasses020a.java</code>            - initial debuggee      <br>
 *     <code>newclassXX/redefineclasses020a.java</code> - redefining debuggees  <br>
 *
 * This test performs the following cases:                                      <br>
 *    1. newclass01 - adding <public> class modifier                            <br>
 *    2. newclass02 - adding <protected> class modifier                         <br>
 *    3. newclass03 - adding <private> class modifier                           <br>
 *    4. newclass04 - adding <static> class modifier                            <br>
...
public class redefineclasses020 {
    ...
    private final static String debuggerName = prefix + "redefineclasses020";
    private final static String debugeeName = debuggerName + "a";
    public  final static String testedClassName = debuggerName + "b$redefineclasses020ib";

    private final static String[][] subDirs = {
            {"newclass01","adding <public> class-modifier"},
            {"newclass02","adding <protected> class-modifier"},
            {"newclass03","adding <private> class-modifier"},
            {"newclass04","adding <static> class-modifier"}
    };
    ...
    public static int run(String argv[], PrintStream out) {
        ...
        redefineclasses020 thisTest = new redefineclasses020();
