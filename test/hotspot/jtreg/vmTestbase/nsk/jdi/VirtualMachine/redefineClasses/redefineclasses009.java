 ...
 *    attempting to change constructor modifiers will throw
 *    <code>UnsupportedOperationException</code> exception"
 *
 * The test consists of the following files:                                    <br>
 *     <code>redefineclasses009.java</code>             - debugger              <br>
 *     <code>redefineclasses009a.java</code>            - initial debuggee      <br>
 *     <code>newclassXX/redefineclasses009a.java</code> - redefining debuggees  <br>
 *
 * This test performs the following cases:                                <br>
 *    1.newclass01 - adding <public> modifier to constructor              <br>
 *    2.newclass02 - adding <protected> modifier to constructor           <br>
 *    3.newclass03 - adding <private> modifier to constructor             <br>
...
public class redefineclasses009 {
    ...
    private final static String debuggerName = prefix + "redefineclasses009";
    private final static String debugeeName = debuggerName + "a";

    private final static String[][] subDirs = {
            {"newclass01","adding <public> modifier to constructor"},
            {"newclass02","adding <protected> modifier to constructor"},
            {"newclass03","adding <private> modifier to constructor"}
    };

    private final static String newClassFile = File.separator
                    + prefix.replace('.',File.separatorChar)
                    + "redefineclasses009a.class";
    ...
    public static int run(String argv[], PrintStream out) {
        ...
        redefineclasses009 thisTest = new redefineclasses009();
    ...
    private void execTest() throws TestBug {
        ...
        BreakpointRequest brkp = debugee.setBreakpoint(testedClass,
                                                    redefineclasses009a.brkpMethodName,
                                                    redefineclasses009a.brkpLineNumber);
        debugee.resume();
        debugee.sendSignal("continue");
